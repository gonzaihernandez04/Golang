...
func main() {
	...
	eleccion := 0
	fmt.Printf("---------- Bienvenido/a a la aplicacion de rutinas ----------\n\n")

	// fmt.Println(eleccion)
	// fmt.Println(reflect.TypeOf(eleccion))
...
func imprimirEleccionesDelMenu() {
	fmt.Println()
	fmt.Println(" 1. Listar rutinas")
	fmt.Println(" 2. Agregar rutinas")
	fmt.Println(" 3. Eliminar rutinas")
	fmt.Println(" 4. Listar ejercicios")
	fmt.Println(" 5. Agregar ejercicios")
	fmt.Println(" 6. Eliminar ejercicios")
	fmt.Println(" 8. Generar rutina automatica por calorias a quemar")
	fmt.Println(" 9. Generar rutina automatica por maximizacion de tipos y duracion")
...
func generacionAutomagicaDeRutinas3() {
	...
	for !fin {
		...
		if duracionMaximaRutina <= 0 && duracionMaximaRutina >= 4 {
			fmt.Println("Duracion invalida. Por favor ingrese un valor entre 1 y 3.")
		}
